...
The exercises in this document follow along closely with [Lesson 10](https://swcarpentry.github.io/r-novice-gapminder/10-functions/index.html) of [R for Reproducible Scientific Analysis](https://swcarpentry.github.io/r-novice-gapminder/), provided by the [Software Carpentry](https://software-carpentry.org/) community under the creative commons license, [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/). For more information see [The Carpentries](https://carpentries.org/).
...
try(fahr_to_celsius('Not a number'))
```
